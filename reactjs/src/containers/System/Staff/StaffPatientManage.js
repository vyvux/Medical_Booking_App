...
class StaffPatientManage extends Component {
  // state = {};
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return (
      <div className="users-container mx-1">
        ...
        <div className="title text-center">Patient Manage</div>
      </div>
    );
  }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(StaffPatientManage);
